...
const leNganTest = `
  describe('Lê Ngân (Sơn)', () => {
    it('Trung Dũng: Đánh 1 lá bài và tuyên bố là 1 lá bài khác (Không ai nghi ngờ)', () => {
      const { createTestState, createTestDispatcher, createCard } = require('./testHelper.js');
      ...
      // Vì p0 đang max HP (3) nên HP không tăng, nhưng lá bài được chuyển vào playedCards / discardPile
